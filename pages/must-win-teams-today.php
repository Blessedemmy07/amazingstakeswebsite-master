...
$apiUrl = "https://backend.sokapedia.com/api/fetch_top_winning_predictions?fixture_date=".$currentDate; 
...
//Seo Content
include_once __DIR__ . "/../components/seo-content/must-win-teams-today.content.php";
