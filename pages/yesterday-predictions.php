...
$yesterdaysDate = date('Y-m-d', strtotime('-1 day')); // Yesterday's date
// Set the API URL for fetching predictions
$apiUrl = "https://backend.sokapedia.com/api/fetch_yesterday_games?fixture_date=".$yesterdaysDate; 
...
//Seo Content
include_once __DIR__ . "/../components/seo-content/yesterday-predictions.content.php";
