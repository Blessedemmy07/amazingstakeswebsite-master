    ...
    <div class="container-fluid flex-grow-1 container-p-y">
        <div class="row justify-content-center">
            <div class="col-md-6">
                ...
                <div class="card">
                    <div class="card-body">
                        <h2 class="card-title text-center" style="font-weight: bold;">EDIT YOUR PROFILE</h2>
                        <div class="row">
                           <?php			
                        ...
                        <form method="POST" action="update_user_profile" class="form-horizontal">
                            <div class="form-group text-left mb-3">
                                <label for="name" style="font-weight: 500;">Name</label>
                                <input type="text" class="form-control" id="name" name="name" value="<?php echo $users_data['fullName']; ?>" required>
                            </div>
                            
                            <div class="form-group text-left mb-3">
                                <label for="email" style="font-weight: 500;">E-mail</label>
                                <input type="email" class="form-control" id="email" name="email" value="<?php echo $users_data['email']; ?>" readonly>
                            </div>
                            
                            <div class="form-group text-left mb-3">
                                <label for="phone" style="font-weight: 500;">Phone Number</label>
                                <input type="text" class="form-control" id="phone" name="phone" value="<?php echo $users_data['phone_number']; ?>" required>
                            </div>
                            
                            <div class="form-group text-left mb-3">
                                <label for="country" style="font-weight: 500;">Country</label>
                                <select id="jsex" name="country" class="form-control" required>
                                    <option selected="selected"><?php echo $users_data['country']; ?></option>
                                    ...
                                    <option value="Korea Democratic People Republic">Korea, Democratic Peoples Republic of</option>
                            ...
                            <div class="form-group text-center mt-4">
                                <button type="button" onclick="window.location.href='dashboard';" class="btn btn-danger me-5" style="width: 120px;">CANCEL</button>
                                <input type="submit" class="btn btn-warning" style="width: 120px; color: #000; font-weight: bold;" name="update" value="UPDATE">
                            </div>
                        </form>
                    </div>
                </div>
