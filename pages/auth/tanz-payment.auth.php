...
$special_plans = $all_vip_plans->FetchSpecialPlans("tanz");

$investment_plans = $all_vip_plans->FetchInvestmentPlans("tanz");
?>
                            ...
                            <div class="row">
                                ...
                                if (count($special_plans) > 0) {
                                    foreach ($special_plans as $row) {
                                        ...
                                        $amount = $row["amount"];
                                        $sign = $row["sign"];
                                        echo "<a href=\"tanz-pay?plan={$plan_id}\"><div class=\"bet-btn-dark-expert\">{$subject_include} {$sign}" . formatNumber($amount) . "</div></a>";
                                    }
                                }
                                ?>
                            </div>
