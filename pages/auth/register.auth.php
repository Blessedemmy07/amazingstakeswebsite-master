                    ...
                    <div class="col-lg-7 col-md-10 col-sm-12">
                        <div class="card shadow-lg border-0 rounded-lg mt-5">                            
                            <div class="card-header">
                                <h2 class="text-center font-weight-light my-4">Register For Free</h2>
                            </div>
                            <div class="card-body">
                                ...
                                <div class="form-floating mb-3">
                                    <input class="form-control" id="fullName" type="text" placeholder="Enter your first name" />
                                ...
                                <div class="form-floating mb-3">
                                    <input class="form-control" id="phone_number" type="text" placeholder="Enter your phone number" />
                                ...
                                <div class="mt-4 mb-0">
                                    <div class="d-grid">
                                        <button class="btn btn-primary btn-block" id="btnRegisterUser" style="background-color:#ffc210; color:black; font-weight:bold">REGISTER</button>
                                    </div>
                                </div>
                            </div>
                            <div class="card-footer text-center py-3">
                                <div class="small">
                                    <a href="/login" style="color: #337ab7; text-decoration: none;">Already have an account? Log in</a>
                                </div>
                            </div>
                        </div>
                        <div class="py-4"></div>
