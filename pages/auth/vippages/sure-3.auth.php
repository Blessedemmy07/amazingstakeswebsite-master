...
$active_plan = $users_data["active_plan"] ?? null;
...
$yesterdayMatches = $matches->FetchSpecialPlanMatches($yesterday, "12");
$todayMatches = $matches->FetchSpecialPlanMatches($today, "12");
$tomorrowMatches = $matches->FetchSpecialPlanMatches($tomorrow, "12");
?>

<div class="content-wrapper">
    <br/>
    <div class="container flex-grow-1 container-p-y">
        <?php if ($active_plan === 0 || $active_plan === 1): ?>
        ...
        <?php elseif ($active_plan === 2): ?>
            <h2>Sure 3 Predictions</h2>
