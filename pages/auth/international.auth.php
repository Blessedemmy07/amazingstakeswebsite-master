...
$special_plans = $all_vip_plans->FetchSpecialPlans("inter");

$investment_plans = $all_vip_plans->FetchInvestmentPlans("inter");
?>
        ...
        <div class="row" style="margin:15px">     
            <div class="col-md-6">
                ...
                <div class="styledCard">
                    <!-- <div class="card-header">
                        <h2 class="mb-0">
                            <button class="btn btn-link" data-toggle="collapse" data-target="#specialPlan" aria-expanded="true">
                                VIP Plan
                            </button>
                        </h2>
                    </div> -->
                            ...
                            <div class="row">
                                ...
                                if (count($special_plans) > 0) {
                                    foreach ($special_plans as $row) {
                                        ...
                                        $amount = $row["amount"];
                                        $sign = $row["sign"];
                                        echo "<a href=\"inter-pay?plan={$plan_id}\"><div class=\"bet-btn-dark-expert\">{$subject_include} {$sign}" . formatNumber($amount) . "</div></a>";
                                    }
                                }
                                ?>
                            </div>
            ...
            <div class="col-md-6">
                ...
                <div class="styledCard">
                    <!-- <div class="card-header">
                        <h2 class="mb-0">
                            <button class="btn btn-link collapsed" data-toggle="collapse" data-target="#investmentPlan" aria-expanded="false">
                                Special Plan
                            </button>
                        </h2>
                    </div> -->
